...
vignette: |
  %\VignetteIndexEntry{Fitting models with trinomix} %\VignetteEngine{knitr::rmarkdown} \usepackage[utf8]{inputenc}
---
...
Second, we can return all parameters (including betas for coefficients and theta, the overdispersion term) 
