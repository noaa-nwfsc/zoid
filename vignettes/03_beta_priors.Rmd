...
```{r}
set.seed(123)
sd = fit_prior(n_bins = 8, n_draws = 1000, target = 1, iterations=10)
```
...
```{r eval=FALSE}
fit <- fit_trinomix(data, prior_sd = 1.2)
```
